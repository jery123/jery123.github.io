    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="action.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
          <textarea id="description" name="description" value="<?= $description; ?>" class="form-control" placeholder="Enter description" rows="4" cols="50">
          Enter description
          </textarea>
            <!-- <input type="email" name="description" value="<?= $description; ?>" class="form-control" placeholder="Enter e-mail" required> -->
          </div>
          <div class="progress">
               <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" aria-label="Warning striped example" style="width: 75%" aria-valuenow="<?= $evolution; ?>" aria-valuemin="0" aria-valuemax="100"></div>
          </div><br>
          <div class="container text-center">
               <div class="row">
                    <div class="col">
                              <button type="button" name="plus" class="btn btn-primary">+</button>
                    </div>
                    <div class="col">
                              <button type="button" name="minus" class="btn btn-danger">-</button>
                    </div>
               </div>
          </div><br>
          <div class="form-group">
            <!-- <input type="tel" name="phone" value="<?= $evolution; ?>" class="form-control" placeholder="Enter phone" required> -->
          </div>
          <div class="form-group">
            <input type="hidden" name="oldimage" value="<?= $photo; ?>">
            <input type="file" name="image" class="custom-file">
